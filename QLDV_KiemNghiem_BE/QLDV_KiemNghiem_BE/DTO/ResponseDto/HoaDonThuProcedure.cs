...
{
    [Keyless]
    public class HoaDonThuProcedure
    {
        ...
        // Danh sách con
        public List<HoaDonThuBoSungProcedure> DsHoaDonThuBoSung { get; set; } = new();
        public List<ChiTietHoaDonThu> DsChiTietHoaDonThu { get; set; } = new();
    }
}
