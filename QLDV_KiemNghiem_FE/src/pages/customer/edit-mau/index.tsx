...
const EditMau = (props: EditMauProps) => {
                  ...
                  <Box className="px-12 py-7 grid grid-cols-1 gap-1">
                    <Box className="col-span-1 grid grid-cols-12 gap-1 2xl:gap-16">
                      <Box className="col-span-12 2xl:col-span-4 h-52 sm:h-[265px] 2xl:h-52">
                        ...
                        <button className="bg-[#D1D5DC] rounded-lg w-full sm:h-52 2xl:h-auto flex justify-center items-center py-11 cursor-pointer">
                    ...
                    <Box className="col-span-1 grid grid-cols-12 gap-6 2xl:gap-16">
