...
const FormThongTinMau = (props: FormThongTinMauProps) => {
  ...
  const handleCreateMau = (data: FormMauEdit) => {
  ...
  const handleEditMau = (data: FormMauEdit) => {
    const index = dataPhieuDangky?.maus.findIndex(
      (item: any) => item.maId === dataEditMaus?.maId
    );
    ...
    const dataMau = {
      ...
      tenMau: data.tenMau,
      maTieuChuan: maTieuChuan,
      maPhieuDangKy: dataEditMaus.maPhieuDangKy,
      manvThucHien: dataEditMaus.manvThucHien,
      madv: dataEditMaus.madv,
      soLo: data.soLo,
      donViSanXuat: data.donViSanXuat,
      ngaySanXuat: data.ngaySanXuat,
      hanSuDung: data.hanSuDung,
      ...
      luuMau: data.luuMau,
      xuatKetQua: data.xuatKetQua,
      trangThaiNhanMau: dataEditMaus.trangThaiNhanMau,
      ghiChu: data.ghiChu,
      nguoiTao: dataEditMaus.nguoiTao,
      nguoiSua: dataEditMaus.nguoiSua,
      ngayTao: dataEditMaus.ngayTao,
      ngaySua: dataEditMaus.ngaySua,
      thoiGianTieuChuan: dataThoiGianTieuChuan.data,
      maPdkMau: dataEditMaus.maPdkMau,
      loaiDv: MaLoaiDV,
      phieuDangKyMauHinhAnhs: dataImage,
    };
  ...
  useEffect(() => {
    if (dataEditMaus) {
      ...
      reset({
        ...
        ngaySanXuat: dataEditMaus?.ngaySanXuat?.split("T")[0] || "",
        hanSuDung: dataEditMaus?.hanSuDung?.split("T")[0] || "",
  ...
  console.log("dataEditMaus", dataEditMaus);
