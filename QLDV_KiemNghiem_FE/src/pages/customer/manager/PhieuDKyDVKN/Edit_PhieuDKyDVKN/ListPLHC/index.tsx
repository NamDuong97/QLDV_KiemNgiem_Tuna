...
const ListPLHC = (props: ListPLHCProps) => {
    ...
    return yup.object().shape({
      TenDM_PLHC: yup
        ...
        .test(
          ...
          (value) => {
            if (dataEditPLHC) {
              const isTrungLap = dataListPLHC?.find(
                (item: any) =>
  ...
  useEffect(() => {
    const dataTableBody = dataListPLHC ? dataListPLHC : [];
  ...
  return (
    <motion.div
      key="danh-sach-phu-lieu-hoa-chat"
