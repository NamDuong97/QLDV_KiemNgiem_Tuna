...
const ThongBao = (props: Props) => {
  ...
  const handleRedirectListMau = () => {
    onSubmit?.();
    navigate(`${url}?tuna=danh-sach-mau`);
  };
            ...
            <Box className="grid gap-6">
              ...
              <Box className="grid gap-1">
                <p className="text-lg/6 font-medium text-center">
                  Xác nhận đã cập nhật lại thông tin vừa thao tác chứ?
                </p>
              </Box>
              <Box className="grid sm:flex gap-6 sm:justify-center">
                <button
                  type="button"
                  className="font-bold text-center text-white bg-[#f8cf00] px-4 py-1 lg:px-10 lg:py-2 rounded-md hover:bg-yellow-500 cursor-pointer"
                  onClick={handleClose}
                >
                  Hủy bỏ
                </button>
