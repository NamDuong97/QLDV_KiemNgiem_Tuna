...
const TableQuanLyPhieuPhanTichKetQua = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.QUAN_LY_PHAN_TICH_KET_QUA.xem_chi_tiet);
...
export default TableQuanLyPhieuPhanTichKetQua;
