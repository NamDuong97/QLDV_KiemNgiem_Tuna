...
const TableDanhSachHoaDon = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.LIST_HOA_DON.xem_chi_tiet);
...
export default TableDanhSachHoaDon;
