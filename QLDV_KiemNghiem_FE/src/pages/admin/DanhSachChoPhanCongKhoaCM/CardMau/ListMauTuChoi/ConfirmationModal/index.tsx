...
const ConfirmationModal = (props: Props) => {
  const { isOpen, onClose, dataId, tenMau } = props;
      ...
      <div className="bg-white">
        ...
        <div className="p-6">
          ...
          <p className="text-center text-gray-500 text-lg mb-6 grid">
            ...
            <span className="text-sm">Bạn muốn từ chối hay chấp nhận</span>
          </p>
          <div className="flex justify-center space-x-3">
            <button
              onClick={handleXoaCung}
              className={`px-4 py-2 text-sm font-medium bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors cursor-pointer`}
            >
              Từ chối
            </button>
