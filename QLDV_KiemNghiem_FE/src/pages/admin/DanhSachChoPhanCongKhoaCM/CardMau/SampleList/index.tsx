          ...
          <div className="px-6 py-4 flex justify-between border-b border-gray-200">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="inline-flex gap-1 items-center justify-center cursor-pointer px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
              >
