...
const ModelCreate = (props: ModelCreateProps) => {
  ...
  let schema = useMemo(() => {
    return yup.object().shape({
      departmentID: yup.string().required("Yêu cầu nhập mã chức vụ"),
      departmentName: yup.string().required("Yêu cầu nhập chức vụ"),
  ...
  return (
    ...
    >
      <Box className="flex justify-between items-center p-9 ">
        <Box>
          <p className="font-bold text-2xl/6">Thêm Bộ Phận</p>
        </Box>
        <Box>
          <IconButton
