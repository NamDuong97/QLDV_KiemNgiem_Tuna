...
const tableBody = [
  ...
  {
    divisionID: "KETOAN",
    divisionName: "Bộ Phận Kế Toán",
    userCreate: "TN010695",
    status: statusDepartment.activity,
  },
  {
    divisionID: "KNG",
    divisionName: "Bộ Phận Kiểm Nghiệm",
    userCreate: "TN010695",
    status: statusDepartment.activity,
  },
  {
    divisionID: "HCQT",
    divisionName: "Bộ Phận Hành Chính Quản Trị",
    userCreate: "TN010695",
    status: statusDepartment.activity,
  },
];
    ...
    <Box className="p-6">
      <Box className="flex justify-between py-6">
        <Box className="flex items-center">
          <h2 className="font-semibold text-2xl">Bộ Phận</h2>
        </Box>
        <Box>
          <button
          ...
          >
            <PersonAddIcon /> <p className="font-medium">Thêm Bộ Phận</p>
          </button>
        </Box>
      </Box>
