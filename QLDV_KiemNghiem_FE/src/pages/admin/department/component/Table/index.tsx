...
import { Department, statusDepartment } from "../../../../../models/department";
...
const Table = (props: TableProps) => {
  ...
  const handleStatus = (status: string) => {
    switch (status) {
      case statusDepartment.activity:
        return (
          <span className="bg-green-600 text-base rounded text-white p-1">
            {status}
          </span>
        );
      case statusDepartment.canceled:
        return (
        ...
        <TableBody className="bg-white">
          {tableBody.map((item, index) => (
            ...
            >
              ...
              <TableCell align="center">
                <Box className="flex gap-2 items-center justify-center">
                  <p className="text-base/4 font-medium hover:underline cursor-pointer">
                    {item.departmentName}
                  </p>
                </Box>
              </TableCell>
