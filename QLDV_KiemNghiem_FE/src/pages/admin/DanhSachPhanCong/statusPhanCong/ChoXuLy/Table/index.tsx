...
const TableChoXuLy = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(
      APP_ROUTES.TUNA_ADMIN.LIST_PHAN_CONG_PHONG_CHUYEN_MON.id_cho_xet_duyet
    );
    sessionStorage.setItem("cho-xet-duyet", JSON.stringify(id));
  };
          ...
          {tableBody?.map((item, index) => (
            ...
            >
              ...
              <TableCell align="center" className="!py-3">
                <Box className="flex gap-2 items-center justify-center">
                  <button
                    onClick={() => handleRedirect(item?.maPhieuDX)}
