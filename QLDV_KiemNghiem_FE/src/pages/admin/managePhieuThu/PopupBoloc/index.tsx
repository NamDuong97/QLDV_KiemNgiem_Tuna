      ...
      <Box className="w-[500px]">
        ...
        >
          ...
          <Box className="flex justify-center gap-6 ">
            <button
              onClick={handleClose}
              className="flex justify-center border-[2px] border-solid border-gray-300 bg-yellow-400 rounded-md px-6 py-[6px] text-white font-bold text-base/6 gap-2 cursor-pointer shadow-[0_4px_4px_rgba(0,0,0,0.25)] hover:bg-yellow-300"
            >
              Tắt thông báo
            </button>
