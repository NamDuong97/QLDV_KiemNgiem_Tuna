...
const TableQuanLyPhieuThu = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.QUAN_LY_PHIEU_THU.xem_chi_tiet);
...
export default TableQuanLyPhieuThu;
