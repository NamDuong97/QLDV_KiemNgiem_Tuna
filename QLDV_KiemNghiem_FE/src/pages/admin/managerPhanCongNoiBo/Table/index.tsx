...
const TableQuanLyPhanCongNoiNo = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.QUAN_LY_PHAN_CONG_NOI_BO.xem_chi_tiet);
...
export default TableQuanLyPhanCongNoiNo;
