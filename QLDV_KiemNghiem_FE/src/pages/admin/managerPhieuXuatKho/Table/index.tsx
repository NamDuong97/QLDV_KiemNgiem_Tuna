...
const TableQuanLyPhieuXuatKho = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.QUAN_LY_PHIEU_XUAT_KHO.xem_chi_tiet);
    sessionStorage.setItem("xem-chi-tiet-nhan-vien", JSON.stringify(id));
  };
...
export default TableQuanLyPhieuXuatKho;
