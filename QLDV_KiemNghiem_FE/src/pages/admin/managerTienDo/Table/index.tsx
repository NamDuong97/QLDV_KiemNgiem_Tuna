...
const TableQuanLyPhieuTienDo = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.QUAN_LY_TIEN_DO.xem_chi_tiet);
...
export default TableQuanLyPhieuTienDo;
