...
import {} from "../../../../../models/Account-Type";
import { Account, statusAccount } from "../../../../../models/Account";
        ...
        <TableBody className="bg-white">
          {tableBody.map((item, index) => (
            ...
            >
              ...
              <TableCell align="center">
                <Box className="flex gap-2 items-center justify-center">
                  <p className="text-base/4 font-medium">{item.divisionName}</p>
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box className="flex gap-2 items-center justify-center">
              ...
              <TableCell align="center">
                {handleStatus(item.statusAccount)}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
