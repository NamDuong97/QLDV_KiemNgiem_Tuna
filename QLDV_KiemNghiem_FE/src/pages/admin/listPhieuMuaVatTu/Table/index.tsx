...
const TableDanhSachPhieuMuaVatTu = (props: TableProps) => {
  ...
  const handleRedirect = (id: any) => {
    navigate(APP_ROUTES.TUNA_ADMIN.LIST_PHIEU_MUA_VAT_TU.xem_chi_tiet);
...
export default TableDanhSachPhieuMuaVatTu;
